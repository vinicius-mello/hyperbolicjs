...
(function() {
  ...
  simulatedAnnealing = function(s, kmax, driver) {
    var E, Emin, k, saIter;
    k = 0;
    Emin = E = driver.energy(s);
    driver.save(s);
    return saIter = function() {
      var T, c, dE, ref, t;
      t = k / kmax;
      if (t >= 1.0) {
        return 1.0;
